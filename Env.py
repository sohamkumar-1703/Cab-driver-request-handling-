...
Original file is located at
    https://colab.research.google.com/drive/1gDAiGv1geX70UuBsMWM3EkbWp6v9B2PV
"""
...
class CabDriver():
    ...
    ## def state_encod_arch(self, state, action):
    ...
    def test_run(self):
        ...
        print("REQUESTS: {}".format(requests[1]))
        ...
        print("NN INPUT LAYER: {}".format(self.state_encod_arch(self.state_init)))
